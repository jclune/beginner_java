    ...
    grunt.initConfig({
        ...
        sass: {
            dist: {
                ...
                files: {
                    '<%= config.app %>/styles/justin.css': ['<%= config.app %>/sass/justin.scss']
                }
            }
        },
        autoprefixer: {
        ...
        concat: {
            dist: {
                files: {
                    '<%= config.dist %>/scripts/justin.js': ['<%= config.app %>/scripts/justin.js']
                }
            }
        },
        cssmin: {
            dist: {
                files: {
                    '<%= config.dist %>/styles/justin.css': ['<%= config.app %>/styles/justin.css']
                }
            }
        },
        uglify: {
